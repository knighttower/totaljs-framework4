...
function prepare(INSTANCE) {
	...
	INSTANCE.cmd_find = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'find', builder: builder });
	};
	...
	INSTANCE.cmd_find2 = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'find2', builder: builder });
	};

	INSTANCE.cmd_memory = function(builder) {
		INSTANCE.send2({ event_type: 'memory', builder: builder });
	};
	...
	INSTANCE.cmd_remove = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'remove', builder: builder });
	};
	...
	INSTANCE.cmd_update = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'update', builder: builder });
	};
	...
	INSTANCE.cmd_insert = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'insert', builder: builder });
	};
	...
	INSTANCE.cmd_alter = function(builder, callback) {
		...
		INSTANCE.send2({ event_type: 'alter', cid: id, builder: builder });
	};
	...
	INSTANCE.cmd_lock = function(builder, callback) {
		...
		if (callback)
			CALLBACKS[id] = callback;
		INSTANCE.send2({ event_type: 'lock', cid: id, builder: builder });
	};

	INSTANCE.cmd_unlock = function(builder) {
		INSTANCE.send2({ event_type: 'unlock', builder: builder });
	};
	...
	INSTANCE.cmd_clean = function(builder, callback) {
		...
		if (callback)
			CALLBACKS[id] = callback;
		INSTANCE.send2({ event_type: 'clean', cid: id, builder: builder });
	};
	...
	INSTANCE.cmd_backups = function(builder, callback) {
		...
		if (callback)
			CALLBACKS[builder.cid] = callback;
		INSTANCE.send2({ event_type: 'backups', builder: builder });
	};

	INSTANCE.cmd_recount = function(builder) {
		INSTANCE.send2({ event_type: 'recount', builder: builder });
	};
	...
	INSTANCE.cmd_clear = function(builder, callback) {
		...
		if (callback)
			CALLBACKS[id] = callback;
		INSTANCE.send2({ event_type: 'clear', cid: id, builder: builder });
	};

	INSTANCE.cmd_drop = function(builder) {
		INSTANCE.send2({ event_type: 'drop', builder: builder });
	};
}
